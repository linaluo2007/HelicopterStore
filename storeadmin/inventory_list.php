...
if(isset($_POST['product_name'])){
	...
	if($productMatch >0){
		echo'Sorry you tried to place a duplicate "Product Nmae" into the system.<a href="inventory_list.php>Click Here</a>';
		exit();
		}
...
<div align="left" id="mainWrapper">
  ...
  <div id="pageContent"><br />
    <div align="right" style="margin-right:30px;"><a href="inventory_list.php#inventoryForm">+ Add New Inventory Item</a></div>
